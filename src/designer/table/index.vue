...
<script>
import {option, tableOption, menuOption, dialogOption, btnOption} from './config/option'
import {pretty} from 'js-object-pretty-print'
import {crudDecoder} from './config/decoder.js'
...
export default {
  ...
  watch: {
    ...
    tableForm: {
      handler() {
        // console.log('crud_option', value);
      },
      deep: true
    },
    list: {
      handler() {
        // console.log('crud_list', value);
      },
      deep: true
    },
  },
